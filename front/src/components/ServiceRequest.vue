<template>
    <div class="container mx-auto flex content-center items-center justify-center h-full w-full">
        ...
        <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
          ...
          <div class="flex-wrap">
            <div class="w-full px-4 inline-block relative mb-3">
              ...
              <radio-form :buttons="['Surgery','Gynecology', 'Obstetrics', 'Pediatrics', 'Radiology', 'Eye', 'ENT', 'Dental', 'Orthopedics', 'Neurology', 'Cardiology', 'Psychiatry', 'Skin']" v-model:input_type="department"
     ...
     />
            ...
            <div v-if="services.length > 1" class="flex flex-nowrap px-4">
  ...
  export default {
    ...
    methods: {
      ...
      UpdateServices(){
        ...
        axios
          .get(`${server_url}/api/services/${this.department}/${this.limit}/${this.limit*this.page}/`, { headers: {"Authorization": 'Token ' + localStorage.access_token} })
          .then((response) => {
