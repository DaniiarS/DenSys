        ...
        <form class="vue-photo-upload-form w-64" @submit.prevent="photo_submit">
            ...
            <div class="flex my-3">
                <label for="vue-photo-upload-file-input">
                    <div :class="[buttonClass ? buttonClass : 'vue-photo-upload-btn']" v-show="enableEdits">Change</div>
                </label>
                <label for="vue-photo-upload-form-submit" v-show="enableEdits">
                    <button :disabled="!vue_photo_selected" :class="[buttonClass ? buttonClass : 'vue-photo-upload-btn']" v-show="enableEdits">Upload</button>
                </label>
            </div>
            <input class="hidden"
            ...
            <span class="message" v-show="vue_photo_selected && enableEdits">Adjust the position and zoom level with your mouse</span>
            -->
        </form>
    </div>
</template>
